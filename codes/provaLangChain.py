...
Per ricavare i valore di "PostiAuto" devi tenere conto dei riferimenti ai posti auto.
Autorimessa e garage equivalgono a "PostiAuto". Nei dati catastali Cat C/6 corrisponde a posto auto. Nel calcolo di vani e mq ignora Cat C/6.
...
[{ "Comune":"", "Indirizzo":"", "Vani":"", "Locali":"", "Mq":"", "Bagni":"", "Piano":"", "PostiAuto":"", "NumProcedura":"", "Lotto":"" }]
...
La continuità delle trascrizioni risulta regolare nel ventennio. PREZZO BASE = Euro 23.000,00. Si precisa che saranno considerate valide le offerte anche inferiori di un quarto rispetto al prezzo base sopra indicato. Tali offerte non potranno essere di importo comunque inferiore ad Euro 17.250,00. Cauzione pari almeno al 10% del prezzo offerto (arrotondamento per eccesso senza decimali). Rilancio minimo di gara: Euro 300,00.""",
        "answer": """[{"Comune":"Brescia", "Indirizzo":"Via Valcamonica 53", "Vani": 3, "Locali": null, "Mq": null, "Bagni": null, "Piano": 2, "PostiAuto": null, "NumProcedura": "116/2023", "Lotto":"LOTTO UNICO"}]""",
    },
    {
        "question": """
...
Catasto Fabbricati - Sez. NCT - Fg. 5 mapp. 358 sub. 9 P. T, cat. A/3 - cl. 3 - vani 8 - R.C. Euro 433,82; mapp. 358 sub. 10 P. T, cat. C/6 - cl. 2 - mq. 20 - R.C. Euro 32,02; mapp. 358 sub. 11 P. T, cat. C/6 - cl. 2 - mq. 33 - R.C. Euro 52,83; mapp. 358 sub. 12 P. 1, cat. A/3 - cl. 3 - vani 5,5 - R.C. Euro 298,25; mapp. 358 sub. 13 P. 1, cat. A/3 - cl. 3 - vani 3,5 - R.C. Euro 189,80; con le proporzionali quote delle parti comuni ai sensi di legge.
Il tutto così come pervenuto in forza di: - provvedimento di acquisizione gratuita al patrimonio dello stato del 27/09/23 dell'Agenzia del Demanio D.R. Lombardia n.2275/2023 rep., trascritto a Brescia il 20/10/23 ai n.ri 46402/32059; - successione legittima, giusta accettazione con beneficio di inventario con atto del 01/10/98 della Pretura Circondariale di Brescia rep. 2125/1998, trascritta il 10/10/98 ai n.ri 32854/21588; - successione legittima - dichiarazione di successione presentata a Chiari il 17/08/92 al n° 52 vol. 362 e trascritta a Brescia il 18/04/94 ai n.ri 10142/7322.
L'immobile è stato costruito ante 01/09/67 ed è interessato dai titoli autorizzativi indicati a pag. 16 e 17 della perizia. Il perito ha rilevato delle difformità urbanistiche come specificato da pag. 17 a pag. 20 della perizia, ove è stata prudenzialmente quantificata anche la spese per il ripristino. Il perito dichiara che le planimetrie catastali non corrispondono esattamente allo stato di fatto per le motivazioni indicate a pag. 23 della perizia.
Nella relazione notarile si segnala la trascrizione della domanda giudiziale di divisione del 18/10/21 del Tribunale di Brescia rep. 11593, trascritta a Brescia il 22/11/21 ai n.ri 55226/36820 (detta trascrizione non verrà cancellata con il decreto di trasferimento). Gli immobili si trovano disabitati.""",

        "answer": """[{"Comune":"Castrezzato", "Indirizzo":"Via Giovanni Pascoli 10", "Vani": 17, "Locali": null,  "Mq": null, "Bagni": null, "Piano": 0, "PostiAuto": 2, "NumProcedura": "11593/2021", "Lotto":"LOTTO UNICO"}]"""  },
    {
        "question": """TRIBUNALE DI BRESCIA UFFICIO ESECUZIONI IMMOBILIARI PROCEDURA ESECUTIVA R.G.E. 71/2018 (V ESPERIMENTO)
...
apparenti e non apparenti.""",
        "answer": """
[
	{"Comune":"Montichiari", "Indirizzo":"Via Santellone 45", "Vani": 9, "Locali": 5,  "Mq": null, "Bagni": 4, "Piano": 0, "PostiAuto": 1, "NumProcedura": "71/2018", "Lotto":"1"},
	{"Comune":"Montichiari", "Indirizzo":"Via Santellone 45", "Vani": null, "Locali": null,  "Mq": 2400, "Bagni": null, "Piano": 0, "PostiAuto": null, "NumProcedura": "71/2018", "Lotto":"2"}
]
""",
    },
    
    {
        "question":"""TRIBUNALE DI BRESCIA SEZIONE ESECUZIONI IMMOBILIARI PROCEDURA ESECUTIVA R.G.E. 148/2023 Giudice dell’Esecuzione: Dott. Alessandro Pernigotto Custode Giudiziario e Professionista Delegato: Avv. Giuseppe Ayroldi
...
""",
        "answer": """[
	{"Comune":"Angolo Terme", "Indirizzo":"Via Regina Elena 95", "Vani": null, "Locali": null,  "Mq": 37, "Bagni": 0, "Piano": 0, "PostiAuto": 0, "NumProcedura": "148/2023", "Lotto":"1"},
	{"Comune":"Angolo Terme", "Indirizzo":"Via Regina Elena 95", "Vani": 4.5, "Locali": 2,  "Mq": 91, "Bagni": 1, "Piano": 1, "PostiAuto": 0, "NumProcedura": "148/2023", "Lotto":"2"},
	{"Comune":"Angolo Terme", "Indirizzo":"Via Regina Elena 95", "Vani": 5, "Locali": 3,  "Mq": 106, "Bagni": 1, "Piano": 2, "PostiAuto": 0, "NumProcedura": "148/2023", "Lotto":"3"}
]"""
    }
]
...
prompt = PromptTemplate(
    ...
    partial_variables={"format_instructions": parser.get_format_instructions(), "system": system, "examples": examples},
)
model = ChatOllama(model="llama3.2:3b-instruct-q4_0", context_length=50000, temperature=0, format="json", top_p=0.4)
model = model.with_structured_output(json.loads(immobile_schema))
